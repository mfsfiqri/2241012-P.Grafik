...
function updateAnimation() {
  ...
  orbitAngle1 += 0.04; // Perubahan sudut untuk orbit

  rotationAngle2 += 0.01; // Rotasi searah jarum jam
  orbitAngle2 += 0.04; // Perubahan sudut untuk orbit berlawanan arah

  rotationAngle3 += 0.01; // Rotasi berlawanan arah jarum jam
  orbitAngle3 += 0.04; // Perubahan sudut untuk orbit

  rotationAngle4 += 0.01; // Rotasi berlawanan arah jarum jam
  orbitAngle4 += 0.04; // Perubahan sudut untuk orbit
}
